...
@section('title', '编辑频道')
@section('page-title', '编辑频道')

@section('content')
<div class="bg-white rounded-lg shadow-md p-6">
    <h2 class="text-xl font-semibold text-gray-800 mb-6">编辑频道</h2>
    ...
    <form method="POST" action="{{ route('admin.channels.update', $channel->id) }}">
        ...
        <div class="mb-4">
            ...
            <input type="url" id="stream_url" name="stream_url" 
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent" 
                   value="{{ $channel->stream_url }}" required>
        </div>
